  ...
  <div ref="rootRef" class="relative">
    ...
    >
      <svg
        ...
        :class="[
          hasValue ? 'text-dunhuang-blue' : 'text-dunhuang-text/25 group-hover:text-dunhuang-blue/50',
    ...
    <Transition :name="dropUp ? 'picker-drop-up' : 'picker-drop'">
      ...
      >
        <div
          ...
          style="box-shadow: 0 8px 28px rgba(92, 64, 51, 0.1), 0 3px 8px rgba(92, 64, 51, 0.05);"
        >
          <!-- 年份切换模式 -->
          <template v-if="mode === 'year'">
            <div class="flex items-center justify-between px-3 py-2 border-b border-dunhuang-yellow/10">
              <button @click="prevYearPage" class="w-7 h-7 rounded-lg flex items-center justify-center text-dunhuang-text/40 hover:bg-dunhuang-yellow/10 hover:text-dunhuang-blue transition-colors">
              ...
              <span class="text-sm font-serif font-bold text-dunhuang-blue">{{ yearStart }} - {{ yearStart + 11 }}</span>
              <button @click="nextYearPage" class="w-7 h-7 rounded-lg flex items-center justify-center text-dunhuang-text/40 hover:bg-dunhuang-yellow/10 hover:text-dunhuang-blue transition-colors">
          ...
          <template v-else-if="mode === 'month'">
            <div class="flex items-center justify-between px-3 py-2 border-b border-dunhuang-yellow/10">
              <button @click="prevYear" class="w-7 h-7 rounded-lg flex items-center justify-center text-dunhuang-text/40 hover:bg-dunhuang-yellow/10 hover:text-dunhuang-blue transition-colors">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="15 18 9 12 15 6" /></svg>
              </button>
              <button @click="mode = 'year'" class="text-sm font-serif font-bold text-dunhuang-blue hover:text-dunhuang-orange transition-colors px-2 py-0.5 rounded hover:bg-dunhuang-yellow/5">
                {{ viewYear }}
              </button>
              <button @click="nextYear" class="w-7 h-7 rounded-lg flex items-center justify-center text-dunhuang-text/40 hover:bg-dunhuang-yellow/10 hover:text-dunhuang-blue transition-colors">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6" /></svg>
              </button>
            </div>
            <div class="grid grid-cols-4 gap-0.5 p-2">
          ...
          <template v-else>
            <!-- 头部：年月导航 -->
            <div class="flex items-center justify-between px-3 py-2 border-b border-dunhuang-yellow/10">
              <button @click="prevMonth" class="w-7 h-7 rounded-lg flex items-center justify-center text-dunhuang-text/40 hover:bg-dunhuang-yellow/10 hover:text-dunhuang-blue transition-colors">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="15 18 9 12 15 6" /></svg>
              </button>
              <div class="flex items-center gap-2">
                <button @click="mode = 'year'" class="text-sm font-serif font-bold text-dunhuang-blue hover:text-dunhuang-orange transition-colors px-1.5 py-0.5 rounded hover:bg-dunhuang-yellow/5">
                  {{ viewYear }}年
                </button>
                <button @click="mode = 'month'" class="text-sm font-serif font-bold text-dunhuang-blue hover:text-dunhuang-orange transition-colors px-1.5 py-0.5 rounded hover:bg-dunhuang-yellow/5">
                  {{ monthLabels[viewMonth] }}月
                </button>
              </div>
              <button @click="prevMonth(false)" class="w-7 h-7 rounded-lg flex items-center justify-center text-dunhuang-text/40 hover:bg-dunhuang-yellow/10 hover:text-dunhuang-blue transition-colors">
                <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="9 18 15 12 9 6" /></svg>
              </button>
            </div>
            ...
            <div class="grid grid-cols-7 px-2 pt-1.5 pb-0.5">
              <span
                ...
                :class="i === 5 || i === 6 ? 'text-dunhuang-orange/60' : 'text-dunhuang-text/30'"
              >{{ w }}</span>
            </div>
            ...
            <div class="grid grid-cols-7 px-2 pb-2">
              <button
                ...
                :class="[
                  ...
                  isToday(day) && isSelected(day) ? 'ring-2 ring-dunhuang-blue/30 ring-offset-1 ring-offset-white' : '',
                ]"
              >
                {{ day.value }}
              </button>
            ...
            <!-- 底部：今天 & 清除 -->
            <div class="flex items-center justify-between px-3 py-2 border-t border-dunhuang-yellow/10 bg-dunhuang-card/80">
              <button
                @click="goToToday"
...
const isToday = (day: { dateStr: string; currentMonth: boolean }) => day.dateStr === todayStr
...
const prevYearPage = () => { yearStart.value -= 12 }
const nextYearPage = () => { yearStart.value += 12 }
